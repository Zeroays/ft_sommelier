...
#    Updated: 2019/07/30 15:51:47 by vrabaib          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def with_feature_scaling(scaling=False):
    ...
    graph_data = updated_data[[x_axis, y_axis, 'quality']]
    ...
    plot_performance(perceptron_performance, graph_data, 8, 3, 15000, True)
